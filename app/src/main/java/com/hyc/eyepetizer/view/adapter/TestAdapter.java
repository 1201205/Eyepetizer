...
public class TestAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    private void bindView(VideoViewHolder holder, ViewData data){
        ItemListData itemData=data.getData();
        ...
        holder.setOnItemClickListener(new VideoViewHolder.ItemClickListener() {
            ...
            public void onItemClicked() {
                Toast.makeText(MainApplication.getApplication(),"-----",Toast.LENGTH_LONG).show();
            }
        });
