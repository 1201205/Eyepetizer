 ...
 */
public class RectangleCardViewProvider extends ItemViewProvider<RectangleCardViewProvider.RectangleCardViewHolder> {
    @Override
    protected RectangleCardViewHolder onCreateViewHolder(LayoutInflater inflater, ViewGroup parent) {
        return new RectangleCardViewHolder(inflater.inflate(R.layout.item_img, parent, false));
    }

    @Override
    protected void onBindViewHolder(RectangleCardViewHolder holder, final ViewData data, int position, AdapterParameterWrapper wrapper) {
    ...
    static class RectangleCardViewHolder extends RecyclerView.ViewHolder {
