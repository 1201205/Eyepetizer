...
public abstract class MDAbsObject3D {
    ...
    public void uploadVerticesBufferIfNeed(MD360Program program, int index) {
        ...
        GLES20.glVertexAttribPointer(positionHandle, sPositionDataSize, GLES20.GL_FLOAT, false, 0,
            vertexBuffer);
    ...
    public void uploadTexCoordinateBufferIfNeed(MD360Program program, int index) {
        ...
        GLES20.glVertexAttribPointer(textureCoordinateHandle, sTextureCoordinateDataSize,
    ...
    public void draw() {
        ...
        if (getIndicesBuffer() != null) {
            ...
            GLES20.glDrawElements(GLES20.GL_TRIANGLES, getNumIndices(), GLES20.GL_UNSIGNED_SHORT,
                getIndicesBuffer());
        } else {
