                    ...
                    synchronized (sGLThreadManager) {
                        while (true) {
                            ...
                            if (mPaused != mRequestPaused) {
                                ...
                                if (LOG_PAUSE_RESUME) {
                                    Log.i("GLThread",
                                        "mPaused is now " + mPaused + " tid=" + getId());
                                }
                            }
                            ...
                            if (mShouldReleaseEglContext) {
                                if (LOG_SURFACE) {
                                    Log.i("GLThread",
                                        "releasing EGL context because asked to tid=" + getId());
                                }
                            ...
                            if (pausing && mHaveEglContext) {
                                ...
                                if (!preserveEglContextOnPause ||
                                    ...
                                    if (LOG_SURFACE) {
                                        Log.i("GLThread",
                                            "releasing EGL context because paused tid=" + getId());
                                    }
                                }
                            }
                            ...
                            if ((!mHasSurface) && (!mWaitingForSurface)) {
                                if (LOG_SURFACE) {
                                    Log.i("GLThread",
                                        "noticed surfaceView surface lost tid=" + getId());
                                }
                                if (mHaveEglSurface) {
                                    stopEglSurfaceLocked();
                                }
                            ...
                            if (mHasSurface && mWaitingForSurface) {
                                if (LOG_SURFACE) {
                                    Log.i("GLThread",
                                        "noticed surfaceView surface acquired tid=" + getId());
                                }
